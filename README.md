...
①Starter/工具<br>
②Starter<br>
自定义Starter不要包含Application<br>
属性类CustomProperties（对应properties/yaml）<br>
核心服务类StarterService<br>
...
# 参考
https://github.com/JeffLi1993/springboot-learning-example（泥瓦匠）<br>
https://github.com/ityouknow/spring-boot-examples（纯洁的微笑）<br>
https://github.com/dyc87112/SpringBoot-Learning（程序猿DD）<br>
https://github.com/xkcoding/spring-boot-demo（xkcoding）<br>
https://github.com/wuyouzhuguli/SpringAll（MrBird）<br>